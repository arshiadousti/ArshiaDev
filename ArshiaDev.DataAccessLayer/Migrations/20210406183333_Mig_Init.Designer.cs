...
namespace ArshiaDev.DataAccessLayer.Migrations
{
    ...
    [Migration("20210406183333_Mig_Init")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArshiaDev.DataAccessLayer.Entities.Posts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ArshiaDev.DataAccessLayer.Entities.Comments", b =>
                {
                    ...
                    b.HasOne("ArshiaDev.DataAccessLayer.Entities.Posts", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("ArshiaDev.DataAccessLayer.Entities.Gallery", b =>
                {
                    b.HasOne("ArshiaDev.DataAccessLayer.Entities.Posts", "Posts")
                        .WithMany("Galleries")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
